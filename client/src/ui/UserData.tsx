...
export default function UserData() {
  ...
  return (
    ...
    <div>
      ...
      <p className="py-2 flex justify-between items-center"><span className='font-semibold'>UserName:</span> <span className='uppercase text-sm'>{user?.username}</span></p>
      ...
      <div className='flex justify-end'><button className="btn btn-primary">Edit Profile</button></div>
    </div>
  </div>
  )
}
